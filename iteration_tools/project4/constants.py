...
fnames =  fname_personal, fname_employment,\
        fname_vehicles, fname_update_status
...
class_names = personal_class_name, employment_class_name, \
                vehicle_class_name, update_status_class_name

# Field Inclusion/Exclusion

personal_fields_compress = [True, True, True, True, True]
employment_fields_copmpress = [True, True, True, False]
vehicle_fields_ccompress = [False, True, True, True]
update_status_fields_compress = [False, True, True]
compress_fields = (personal_fields_compress, employment_fields_copmpress,\
                   vehicle_fields_ccompress, update_status_fields_compress)